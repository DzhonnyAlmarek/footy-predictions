...
export async function POST(req: Request) {
  try {
    ...
    const home_pred: number | null = home_pred_raw === null || home_pred_raw === "" ? null : Number(home_pred_raw);
    const away_pred: number | null = away_pred_raw === null || away_pred_raw === "" ? null : Number(away_pred_raw);

    // если один null, другой нет — считаем плохим payload
