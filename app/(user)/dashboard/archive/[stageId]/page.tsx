...
export default async function ArchiveStageTablePage({
  params,
}: {
  ...
  if (!stage || stage.status !== "locked") {
    return (
      <main className="page">
        ...
        <p className="pageMeta">Этот этап не найден или ещё не завершён.</p>
      </main>
    );
  }
  ...
  return (
    <main className="page">
      ...
      <div className="pageMeta">
        Этап: <b>{stage.name}</b>
        <span> • завершён</span>
        {stage.is_current ? <span> • текущий отмечен ⭐</span> : null}
      </div>
